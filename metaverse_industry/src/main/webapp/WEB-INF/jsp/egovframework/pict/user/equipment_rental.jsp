                                            ...
                                            <div class="bookingContainer con01">
                                                                ...
                                                                <li data-id="${equipment.id}"
                                                                    ...
                                                                    <div class="checkItem list">
                                                                        <div class="itemTitles">
                                                                            ...
                                                                            <p><span>${equipment.name}</span><span> /
                                                ...
                                                <div class="bookingInner date">
                                                    <div class="disable-calendar">
                                                        <p>좌측 장비를 선택하고<br /> 대여일/반납일을 선택해주세요</p>
                                                    </div>
                                            ...
                                            <div class="modalContents">
                                                ...
                                                <div class="agreeContent">
                                                    ...
                                                    <p style="margin-left: 10px;">              
                                                        ...
                                                        4. 기타 센터 관리자와 사전 협의가 이뤄진 사용자 (개정 2024. 03. 19.)<br>
                                                        5. 중복 예약 시 기업 지원을 우선으로 함 (신설 2024. 03. 19.)
                                                    </p>
                                                    <p><span>②</span>미성년자는 보호자 동행하여, 센터 인프라(시설·장비)를 사용할 수 있다. (개정 2024. 03. 19.)</p>
                                                </div>
                                                <div class="agreeContent">
                                                    <h3>제3조(운영시간 및 사용료)</h3>
                                                    <p><span>①</span>센터 인프라(시설·장비)의 운영시간은 다음 각 호와 같다.</p>
                                                    <p style="margin-left: 10px;">
                                                        1. 운영시간: 평일 10시부터 17시까지 (개정 2024. 03. 19.)<br>
                                                ...
                                                <div class="agreeContent">
                                                    ...
                                                    <p><span>②</span>사용 기간은 단기사용 최대 15일, 장기사용 최대 3개월이며, 1개월 이상 사용 시 센터 관리자에게 중간보고를 해야 한다. (개정 2024. 03. 19.)</p>
                                                    <p><span>③</span>제1항의 사용신청 시 최초 신청자는 사업자등록증, 신분증, 관련 자격증 등을 제출해야 한다. (개정 2024. 03. 19.)</p>
                                                    <p><span>④</span>장기사용과‘제  2조 제1항 4호’의 경우, 관련 사업계획서(자유 양식)를 상세히 작성하여 제출하고 센터 관리자가 타당하다고 판단하면 사용할 수 있다. (개정 2024. 03. 19.)</p>
                                                    <p><span>⑤</span>모션캡쳐룸과 브이튜버룸의 경우, 공용시설(랩실, 회의실, 테스트베드룸)과 함께 사용할 수 있다. (신설 2024. 03. 19.)</p>
                                                </div>
                                                <div class="agreeContent">
                                                    <h3>제5조(장비 사용신청)</h3>
                                                    <p><span>①</span>장비의 사용신청은 강원 메타버스 지원센터 홈페이지를 통해 법정 공휴일 및 주말을 제외한 사용 희망일 최소 1일 전 예약해야 한다.</p>
                                                    <p><span>②</span>사용 기간은 단기사용 최대 15일, 장기사용 최대 3개월이며, 1개월 이상 사용 시 센터 관리자에게 중간보고를 해야 한다. 다만, 센터 관리자와 사전 협의를 통해 6~12개월 사용할 수 있다. (개정 2024. 03. 19.)</p>
                                                    <p><span>③</span>제1항의 사용신청 시 최대 사용 수량은 4대이며, 최초 신청자는 사업자등록증, 신분증, 관련 자격증 등을 제출해야 한다. (개정 2024. 03. 19.)</p>
                                                    <p><span>④</span>장기사용과‘제2조 제1항 4호’의 경우, 관련 사업계획서(자유 양식)를 상세히 작성하여 제출하고 센터 관리자가 타당하다고 판단하면 사용할 수 있다. (개정 2024. 03. 19.)</p>
                                                </div>
                                                <div class="agreeContent">
                                                    <h3>제6조(사용목적)</h3>
                                                    <p><span>①</span>사용자는 센터 인프라(시설·장비) 사용 신청 시‘사용목적’을 반드시 작성해야 한다. (개정 2024. 03. 19.)</p>
                                                    ...
                                                    <p><span>④</span>기타 현행 법률에 저촉되거나 부적절한(폭력적, 선정적 등) 콘텐츠를 제작하는 경우 (개정 2024. 03. 19.)</p>
                                                </div>
                                                <div class="agreeContent">
                                                    <h3>제7조(사용 승인 거절)</h3>
                                                    ...
                                                    <p style="margin-left: 10px;">
                                                        ...
                                                        2. 기존 센터 인프라(시설·장비)를 사용 시 훼손, 분실 등 피해를 준 경우(개정 2024. 03. 19.)<br>
                                                        3. 기존에 유관기관과 강원정보문화산업진흥원에서 운영하는 다른 인프라(시설·장비) 사용에 있어서 유사 지침 위반 사례가 있는 경우(신설 2024. 03. 19.)<br>
                                                        4. 기타 센터 관리자가 운영상의 이유로 사용신청에 문제가 있다고 판단하는 경우
                                                    </p>
                                                </div>
                                                <div class="agreeContent">
                                                    <h3>제8조(사용 및 반납)</h3>
                                                    <p><span>①</span>사용과 반납은 사용자 신청 기간을 준수해야 한다. 예약 이후, 별도 연락 없이 사용하지 않을 경우, 센터 관리자는 사용을 취소할 수 있으며, 제10조(자격 제한)에 따라 주의 조치할 수 있다. (개정 2024. 03. 19.)</p>
                                                    <p><span>②</span>사용과 반납은 신청자 본인이 원칙이며, 대리 사용과 반���은 불가하다. 다만, 센터 관리자로부터 합리적인 사유(질병, 사고 등)로 사전에 승인을 득했을 때는 가능하며, 추가 신분 확인이 진행된다. (개정 2024. 03. 19.)</p>
                                                    <p><span>③</span>사용자는 인프라 사용 이��� 반납 시 원상 복귀(SW 임의 설치, 정리 정돈 등)해야 한다. (신설 2024. 03. 19.)</p>
                                                    <p><span>④</span>사용과 반납 시, 센터 관리자는 인프라(시설·장비)의 정상 작동 여부를 확인하며, 사용자는 이에 적극적으로 임해야 한다. (개정 2024. 03. 19.)</p>
                                                    <p><span>⑤</span>사용자는 사용과 반납 시 신분 확인 절차에 응해야 한다. (개정 2024. 03. 19.)</p>
                                                    <p><span>⑥</span>사용자는 인프라(시설·장비)의 사용 완료 이후 만족도 조사, 사용 완료 서명 등을 작성해야 한다. (신설 2024. 03. 19.)</p>
                                                    <p><span>⑦</span>장비 사용기간 연장은 센터 관리자의 사전 승인 없이 자체 연장이 불가하다. (신설 2024. 03. 19.)</p>
                                                </div>
                                                <div class="agreeContent">
                                                    <h3>제9조(후원 명칭 사용 등)</h3>
                                                    <p><span>①</span>사용자는 센터 관리자가 콘텐츠 결과물을 공유 요청할 시, 반드시 제출해야 한다. (신설 2024. 03. 19.)</p>
                                                    <p><span>②</span>사용자는 센터 인프라(시설·장비)를 활용한 결과물에 대하여,‘본 콘텐츠는 강원 메타버스 지원센터의 후원으로 만들어졌습니다.’를 표기하여, 결과물 복사본 1부를 제출해야 한다. (개정 2024. 03. 19.)</p>
                                                    <p><span>③</span>제출된 결과물은 본 센터의 홍보, 교육, 결과보고 등을 위해 비영리 목적으로 활용될 수 있다. (개정 2024. 03. 19.)</p>
                                                </div>
                                                <div class="agreeContent">
                                                    <h3>제10조(자격 제한)</h3>
                                                ...
                                                <div class="agreeContent">
                                                    ...
                                                    <p><span>③</span>반납 시 작동에 문제가 있을 시 사용자는 구매 또는 수리하여 반납해야 한다.(신설 2024. 03. 19.)</p>
                                                    <p style="margin-left: 10px;">
                                                        1. 제8조(사용 및 반납) 2항인 경우 당초 신청자에게 책임이 있음<br>   
                                                        2. 제11조(자격 정지) 5, 6호로 원상 복귀를 위해 사용자는 구매 또는 수리해야 함
                                                    </p>    
                                                    <p><span>④</span>센터 인프라(시설·장비)를 훼손 또는 파손했을 때는 수리하여 반납해야 한다.(개정 2024. 03. 19.)</p>
