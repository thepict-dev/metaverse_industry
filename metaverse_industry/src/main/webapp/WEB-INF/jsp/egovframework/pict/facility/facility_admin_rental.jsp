			...
			<%@ taglib prefix="ui" uri="http://egovframework.gov/ctl/ui" %>
				<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
					...
					<%@include file="../main/lnb.jsp" %>
									...
									<div class="ListWrpper">
										...
										<div class="pagination">
											<c:if test="${pictVO.pageNumber > 1}">
												<li>
													<a href="/facility/facility_admin_rental.do?search_text=${param.search_text}&pageNumber=${pictVO.pageNumber - 10 < 1 ? 1 : pictVO.pageNumber - 10}">
											...
											<c:forEach var="i" begin="${pictVO.startPage}" end="${pictVO.endPage}">
												<li>
													<a href="/facility/facility_admin_rental.do?search_text=${param.search_text}&pageNumber=${i}" class="${i eq pictVO.pageNumber ? 'active' : ''}">${i}</a>
												</li>
											</c:forEach>
											
											<c:if test="${pictVO.pageNumber < pictVO.lastPage}">
												<li>
													<a href="/facility/facility_admin_rental.do?search_text=&pageNumber=${pictVO.pageNumber + 10 > pictVO.lastPage ?  pictVO.lastPage : pictVO.pageNumber + 10}"><img
								...
								<div class="detailInfoContainer">
									<div class="detailList">
										...
										<div class="buttons" style="padding: 0 24px;">
			                        		<a href="#lnk" class="white normalButton" id="rentalButton">시설대여</a>
		                        		</div>
									</div>
								</div>
							</div>
						...
						<script type="text/javascript" src="/js/facility_admin_rental.js"></script>
