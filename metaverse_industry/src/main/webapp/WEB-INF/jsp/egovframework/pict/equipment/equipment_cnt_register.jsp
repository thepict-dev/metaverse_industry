								...
								<div class="listContainer">
									<div class="listInner">
										<form action="" id="register" name="register" method="post"
											...
											<input type="hidden" name="status" id="status" value="${pictVO.status}">
											<div class="inputsContainer">
												...
												<div class="inputBox">
													...
													<div class="switchInput nonTop">
														<input type="checkbox" class="toggle" name="toggle" <c:if
											...
											<div class="inputsContainer">
												<div class="inputBox" style="width:100%">
													...
													<textarea name="text" id="bujajae" cols="50" rows="10" class="txt"
														style="width:100%;">${pictVO.text}</textarea>
												</div>
											</div>
									...
									<c:if test="${pictVO.image_url != null && pictVO.image_url != ''}">
