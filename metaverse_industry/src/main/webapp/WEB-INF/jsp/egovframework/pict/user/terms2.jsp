			...
			<div class="termsContentsWrapper">
				...
				<div class="termsContents">
					...
					<p class="termsDesc">
						...
						<i style="color: red;">③ 회원이 변경된 약관에 동의하지 않을 경우, 서비스 이용을 중단하고 탈퇴할 수 있습니다. 약관이 변경된 이후에도 계속적으로 서비스를 이용하는 경우에는 회원이 약관의 변경 사항에 동의한 것으로 봅니다.<br></i>
				...
				<div class="termsContents">
					...
					<p class="termsDesc">회원은 서비스를 이용하여 불법 상품을 판매하는 영업활동을 할 수 없으며 특히 해킹, 돈 벌기 광고, 음란사이트를 통한 상업행위 등을 할 수 없습니다. 이를 위반하고 발생한 영업활동의 결과 및 손실, 관계기관에 의한 구속 등 법적 조치 등에 관해서는 "강원VR·AR제작거점센터"가 책임을 지지 않습니다.</p>
				</div>
				<div class="termsContents">
					...
					<p class="termsSubDesc">
						...
						7. "강원 메타버스 지원센터"의 서비스 정보를 이용하여 얻은 정보를 "강원VR·AR제작거점센터"의 사전 승낙 없이 복제 또는 유통하거나 상업적으로 이용하는 경우<br>
