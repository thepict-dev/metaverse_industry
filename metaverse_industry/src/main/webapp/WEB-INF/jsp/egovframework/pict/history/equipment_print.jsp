	    ...
	    <div class="printWrapper">
	        ...
	        <div class="printBottom">
	            ...
	            <div class="sectionsInfoWrapper half">
	                <div class="printSection">
	                    <p class="sectionTitle">사용 신청 장비</p>
	                    <ul class="sectionsInfo">
	                        <li>
	                            <div class="row">
	                ...
	                <div class="printSection">
	                    ...
	                    <ul class="sectionsInfo">
	                        <li>
	                            <div class="row">
	                                <span>${history_detail.equipment_plan}</span>
	                            </div>
	                        </li>
	                    </ul>
	                </div>
	            ...
	            <div class="cutting">
	                ...
	                <div class="cuttingContainer">
	                    <div class="sectionsInfoWrapper half">
	                        <div class="printSection">
	                            <p class="sectionTitle dates"><span>대여일</span><span>${pdf.rentalOnlyStartDate}</span></p>
	                            <ul class="sectionsInfo">
	                                <li>
	                                    <div class="row dates">
	                                        <p>이용자</p>
	                        ...
	                        <div class="printSection">
	                            <p class="sectionTitle dates"><span>대여일</span><span>${pdf.rentalOnlyEndDate}</span></p>
	                            <ul class="sectionsInfo">
	                                <li>
	                                    <div class="row dates">
	                                        <p>이용자</p>
