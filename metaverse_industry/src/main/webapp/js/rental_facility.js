...
const callBookingApi = () => {
    ...
    if (rental_type === "individual") {
        ...
        formData.append("facility_plan", document.querySelector(".equipment-plan-individual").value);
        let indexArray = [];
        ...
        formData.append("facility_plan", document.querySelector(".equipment-plan-company").value);
